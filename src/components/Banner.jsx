...
const Banner = () => {
  ...
  <div className="flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden">
    ...
    <p className="mt-2">Monetize your vehicale effortlessly by listing it on CarRental.</p>
    ...
    <button className="px-6 py-2 bg-white rounded-xl mt-2 text-blue-500 hover:bg-slate-100 transition-all">List your car</button>
    </div>
