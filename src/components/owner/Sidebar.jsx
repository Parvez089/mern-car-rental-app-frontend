...
const Sidebar = () => {
  ...
  return (
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 maxw13 md:max-w-60 w-full border-r border-borderColor text-sm">
    ...
    <p className="mt2 text-base max-md:hidden">{user?.name}</p>
